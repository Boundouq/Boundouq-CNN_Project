...
for IMAGE_NUM in range(NUM):
    ...
    out_convolution_64 = convolution.convolution(rgb ,0,weights_64,biases_64, B, X,W)
    ...
    # Calculate convolution
    out_convolution_32 = convolution.convolution(tab_out_64,1,weights_32,biases_32, B, X,W)
    ...
    # Calculate convolution
    out_convolution_20 = convolution.convolution(tab_out_32,2,weights_20,biases_20, B, X,W)
    ...
    if classe == t[0] :pass_1 += 1
    if classe == t[1] :pass_2 += 1
    if classe == t[2] :pass_3 += 1

pass_1 *= (100./NUM *1);
pass_2 *= (100./NUM *1);
pass_3 *= (100./NUM *1);

print ("Number of image: " + str (NUM))
print ("Passed as first class detected: " + str (pass_1) + '%')
print ("Passed as second class detected: " + str (pass_2) + '%')
print ("Passed as third class detected: " + str (pass_3) + '%')